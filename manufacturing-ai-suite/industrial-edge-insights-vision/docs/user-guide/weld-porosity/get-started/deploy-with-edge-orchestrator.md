...
3. On the Setup a Deployment page, select the **wp** package for the deployment from the list, and click **Next**. The Select a Profile step appears.
...
1. Follow the steps in the **Weld Porosity** [Documentation](./deploy-with-helm.md#deploy-the-application) on the usage of the application.
