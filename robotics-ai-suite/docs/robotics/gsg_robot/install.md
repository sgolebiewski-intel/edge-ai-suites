...
<!--hide_directive:sync: tab1hide_directive-->
   ...
   2. Before using the Autonomous Mobile Robot APT repositories, update the APT packages list:
      ...
      #. Before using the Autonomous Mobile Robot APT repositories,
      ...
      #. Install the chosen Autonomous Mobile Robot Deb package.
         ...
         > **Note:** Before you install ros-humble-robotics-sdk-complete (or any other
           packages that depend on OpenVINO), please read the information on [OpenVINO installation](./install-openvino.md).
...
To run Autonomous Mobile Robot in a Docker container you must have Docker installed on your system. You can go with an existing installation or start with a fresh install.
   ...
   **Install Docker**
   ...
   Follow the [Install Docker_Engine on Ubuntu OS](https://docs.docker.com/engine/install/ubuntu/) guide, to install Docker on your target system.
